...
import stardewvalleyautomaton.Model.Personnages.AutomateAbigail.Attendre;
import stardewvalleyautomaton.Model.Personnages.AutomateAbigail.Etat;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    public int distance(Objet obj) {
        return Carte.get().getGraphe().distanceDijkstra(this.abigail.getPositionCourante(), 
