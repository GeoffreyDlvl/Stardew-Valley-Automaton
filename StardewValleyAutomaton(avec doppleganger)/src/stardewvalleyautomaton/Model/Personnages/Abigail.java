...
public class Abigail extends Personnage {
    ...
    public void traire() {
        ...
        for(Personnage vache : listeDesVaches) {
            if(lait) {
                ...
                ((Vache) vache).traire();
                System.out.println("Abigail a traie la vache");
                this.lait = true;
            }
            else {
    ...
    public void boireLait() {
        if(this.lait) {
            this.lait = false;
            this.soif = 0;
            System.out.println("Abigail boit du lait");
        } else {
            System.out.println("Abigail a n'a pas de lait !");
        }
    }
    ...
    public void mangerFromage() {
        if(this.fromage) {
            this.fromage = false;
            this.faim = 0;
            System.out.println("Abigail mange un fromage");
        } else {
            System.out.println("Abigail a n'a pas de fromage !");
        }        
    }
    ...
    public void action(Enum_Action action) {
        super.action(action);
        if(action==attendre) {
            System.out.println("Abigail se sent plus reposée.");
            fatigue = fatigue - 50;
            if(fatigue < 0) {
                fatigue = 0;
            }
