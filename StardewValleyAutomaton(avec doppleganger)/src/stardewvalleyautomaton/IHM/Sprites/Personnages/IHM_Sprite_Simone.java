...
import static stardewvalleyautomaton.IHM.Sprites.Enum_IHM_Sprite.IHM_Simone;

/**
 *
 * @author Matthieu
 */
public class IHM_Sprite_Simone extends IHM_Sprite_Personnage {

    private static final int NOMBRE_MODIFIEUR = 134;                            //nombre de modifieurs différents
    
    //CONSTRUCTEUR -------------------------------------------------------------
    public IHM_Sprite_Simone() {
        super("Simone", NOMBRE_MODIFIEUR);
